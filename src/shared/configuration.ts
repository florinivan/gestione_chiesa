 ...
 *
 */
export const BROWSER_ROUTER_PREFIX_PREMATCH = `${ENV.REACT_APP_BROWSER_ROUTER_PREFIX_PREMATCH}`;
export const BROWSER_ROUTER_PREFIX_LIVE = `${ENV.REACT_APP_BROWSER_ROUTER_PREFIX_LIVE}`;

/**
 * Browser router paths
 */
export const BROWSER_ROUTER_PATH_MAP = {
  SHOWCASE_PREMATCH: `${BROWSER_ROUTER_PREFIX_PREMATCH}/`,
  SPECIAL_PREMATCH: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPECIAL_PREMATCH}`,
  SPORTSBOOK_SPORT: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORTSBOOK_SPORT}`,
  SPORT_SHOWCASE_PREMATCH: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_SHOWCASE_PREMATCH}`,
  SPORT_COMPETITIONS_PREMATCH: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_COMPETITIONS_PREMATCH}`,
  SPORT_COMPETITIONS_PREMATCH_COUNTRY: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_COMPETITIONS_PREMATCH_COUNTRY}`,
  SPORT_REGULATOR_PREMATCH: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_REGULATOR_PREMATCH}`,
  SPORT_REGULATOR_PREMATCH_COUNTRY: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_REGULATOR_PREMATCH_COUNTRY}`,
  SPORT_RESERVATION: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_RESERVATION}`,
  SPORT_TIPSTER: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SPORT_TIPSTER}`,
  PLAYER_DETAILS: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_PLAYER_DETAILS}`,
  PLAYER_DETAILS_COUNTRY: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_PLAYER_DETAILS_COUNTRY}`,
  SHARED_TICKET: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_SHARED_TICKET}`,

  SHOWCASE_LIVE: `${BROWSER_ROUTER_PREFIX_LIVE}/`,
  FAVORITE_LIVE: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_FAVORITE_LIVE}`,
  SPORT_SHOWCASE_LIVE: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_SPORT_SHOWCASE_LIVE}`,
  SPORT_COMPETITIONS_LIVE: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_SPORT_COMPETITIONS_LIVE}`,
  SPORT_REGULATOR_LIVE: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_SPORT_REGULATOR_LIVE}`,
  SPORT_REGULATOR_LIVE_COUNTRY: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_SPORT_REGULATOR_LIVE_COUNTRY}`,
  CALENDAR: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_CALENDAR}`,
  SPORT_CALENDAR: `${BROWSER_ROUTER_PREFIX_LIVE}/${ENV.REACT_APP_SPORT_CALENDAR}`
};

/**
 * List of sports' path
 */
const BROWSER_ROUTER_SPORTS_PATH_PREMATCH = [
  BROWSER_ROUTER_PATH_MAP.SPORT_SHOWCASE_PREMATCH,
  BROWSER_ROUTER_PATH_MAP.SPORT_COMPETITIONS_PREMATCH_COUNTRY,
  BROWSER_ROUTER_PATH_MAP.SPORT_COMPETITIONS_PREMATCH,
  BROWSER_ROUTER_PATH_MAP.SPORT_REGULATOR_PREMATCH_COUNTRY,
  BROWSER_ROUTER_PATH_MAP.SPORT_REGULATOR_PREMATCH,
  BROWSER_ROUTER_PATH_MAP.PLAYER_DETAILS_COUNTRY,
  BROWSER_ROUTER_PATH_MAP.PLAYER_DETAILS
];
const BROWSER_ROUTER_SPORTS_PATH_LIVE = [
  BROWSER_ROUTER_PATH_MAP.SPORT_SHOWCASE_LIVE,
  BROWSER_ROUTER_PATH_MAP.SPORT_COMPETITIONS_LIVE,
  BROWSER_ROUTER_PATH_MAP.SPORT_REGULATOR_LIVE,
  BROWSER_ROUTER_PATH_MAP.SPORT_REGULATOR_LIVE_COUNTRY,
  BROWSER_ROUTER_PATH_MAP.SPORT_CALENDAR
];

const BROWSER_ROUTER_PLAYER_COMPETITIONS_PAGE_PATH = [
  BROWSER_ROUTER_PATH_MAP.SPORT_COMPETITIONS_PREMATCH_COUNTRY,
  BROWSER_ROUTER_PATH_MAP.SPORT_COMPETITIONS_PREMATCH
];

const BROWSER_ROUTER_PLAYER_DETAILS_PAGE_PATH = [
  BROWSER_ROUTER_PATH_MAP.PLAYER_DETAILS_COUNTRY,
  BROWSER_ROUTER_PATH_MAP.PLAYER_DETAILS
];
...
const API_BASE_PREMATCH = `${API_BASE}/${ENV.REACT_APP_API_BASE_PREMATCH}`;
const API_BASE_LIVE = `${API_BASE}/${ENV.REACT_APP_API_BASE_LIVE}`;

/**
 * API base streaming
 */
const API_BASE_STREAMING = `${API_BASE}/${ENV.REACT_APP_API_BASE_STREAMING}`;
...
const FAKE_ALL_SPORTS_KEY = FAKE_SPORTS.ALL.ID + '';

const TOP_BETS_RECORDS_SIZE = 3;
 ...
 */
const WIDGETS_ROUTE = {
  TOP: `${BROWSER_ROUTER_PREFIX_PREMATCH}`,
  RESERVATION: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_RESERVATION}`,
  TIPSTER: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_TIPSTER}`,
  SPECIALS: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_SPECIALS}`,
  SPORTSBOOK: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_SPORTSBOOK}`,
  SPORT: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_SPORT}`,
  QUOTE: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_QUOTE}`,
  EVENT: `${BROWSER_ROUTER_PREFIX_PREMATCH}/${ENV.REACT_APP_WIDGET_ROUTE_EVENT}`
};
...
const Config = {
  ...
  BROWSER_ROUTER_PREFIX_PREMATCH,
  BROWSER_ROUTER_PREFIX_LIVE,
  BROWSER_ROUTER_PATH_MAP,
  BROWSER_ROUTER_SPORTS_PATH_PREMATCH,
  BROWSER_ROUTER_SPORTS_PATH_LIVE,
  BROWSER_ROUTER_PLAYER_DETAILS_PAGE_PATH,
  BROWSER_ROUTER_PLAYER_COMPETITIONS_PAGE_PATH,
  API_BASE,
  API_BASE_PREMATCH,
  API_BASE_LIVE,
  FAKE_SPORTS,
