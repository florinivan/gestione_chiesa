...
export const BROWSER_ROUTER_PATH_MAP = {
  SHOWCASE_PREMATCH: `${BROWSER_ROUTER_PREFIX}/`,
  SPECIAL_PREMATCH: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPECIAL_PREMATCH}`,
  SPORTSBOOK_SPORT: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORTSBOOK_SPORT}`,
  SPORT_SHOWCASE_PREMATCH: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_SHOWCASE_PREMATCH}`,
  SPORT_COMPETITIONS_PREMATCH: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_COMPETITIONS_PREMATCH}`,
  SPORT_COMPETITIONS_PREMATCH_COUNTRY: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_COMPETITIONS_PREMATCH_COUNTRY}`,
  SPORT_REGULATOR_PREMATCH: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_REGULATOR_PREMATCH}`,
  SPORT_REGULATOR_PREMATCH_COUNTRY: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_REGULATOR_PREMATCH_COUNTRY}`,
  SPORT_RESERVATION: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_RESERVATION}`,
  SPORT_TIPSTER: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SPORT_TIPSTER}`,
  PLAYER_DETAILS: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_PLAYER_DETAILS}`,
  PLAYER_DETAILS_COUNTRY: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_PLAYER_DETAILS_COUNTRY}`,
  SHARED_TICKET: `${BROWSER_ROUTER_PREFIX}/${ENV.REACT_APP_SHARED_TICKET}`
};
